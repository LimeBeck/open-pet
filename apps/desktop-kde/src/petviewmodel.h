...
public:
    ...
    // Смещение процедурного движения в координатах окна. Маска едет следом,
    // иначе питомец виден в одном месте, а клики принимает в другом.
    Q_INVOKABLE void setMotionOffset(int x, int y);
